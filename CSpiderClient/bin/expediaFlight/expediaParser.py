        ...
        for legs_list in search_legs:
            for legs_key in legs_list:
                if legs_key == key_list[2]: #legs list
                    ...
                    for child_list in legs_child_list:
                        for child_key in child_list:
                            ...
                            #* each flight
                                        ...
                                        flights[flight_key] = (each_flight_no,each_airline,each_plane,\
                    ...
                    tickets.append((ticket_flight_no,ticket_plane_no,ticket_airline,ticket_dept_id,\
...
def expedia_request_parser(taskcontent):
    result = -1
