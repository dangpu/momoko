...
for w in zh2Hant:
    w_temp = w.decode('utf-8')
    v_temp = zh2Hant[w].decode('utf-8')
    fanjian_dict[v_temp] = w_temp


def fan_to_jian(str_content):
    str_content = str_content.decode('utf-8')
    
    str_list = list(str_content)
    new_str = ''
    for each_str in str_list:
        if each_str in fanjian_dict:
            each_str = fanjian_dict[each_str]
        new_str += each_str
